...
# ------------------------------------
plot.dat <- read.csv("processed_data/eastern_ITRDB_metadata.csv")
names(plot.dat)

plot.dat <- plot.dat[,c("studyCode", "siteName", "Latitude", "Longitude", "Elevation", "species.code")]
names(plot.dat) <- c("Site.Code", "site.name", "latitude","longitude", "elevation", "species")
plot.dat$studyCode <- as.factor(plot.dat$studyCode)
plot.dat$state <- as.factor(substr(plot.dat$studyCode, 1,2))
summary(plot.dat)
...
summary(sites.met)
write.csv(sites.met, "processed_data/prism_met_ITRDB_sites.csv", row.names=F)
# ------------------------
# ------------------------------------

sites.met <- read.csv("processed_data/prism_met_ITRDB_sites.csv")
...
write.csv(sites.met, "processed_data/prism_met_ITRDB_sites_lags.csv", row.names=F)
# ------------------------------------

sites.met <- read.csv("processed_data/prism_met_ITRDB_sites_lags.csv")
...
write.csv(tmean.wide, "processed_data/prism_met_ITRDB_sites_wide_tmean.csv", row.names=F)
# ---------------------
...
write.csv(tmax.wide, "processed_data/prism_met_ITRDB_sites_wide_tmax.csv", row.names=F)
# ---------------------
...
write.csv(tmin.wide, "processed_data/prism_met_ITRDB_sites_wide_tmin.csv", row.names=F)
# ---------------------
...
write.csv(ppt.wide, "processed_data/prism_met_ITRDB_sites_wide_ppt.csv", row.names=F)
# ---------------------
